...
function createCard(animal, image, animalContainer) {
  ...
  detailsOne.appendChild(valuePhylum);
  detailsOne.appendChild(labelClass);
  detailsOne.appendChild(valueClass);
  detailsOne.appendChild(labelOrder);
  detailsOne.appendChild(valueOrder);
  detailsOne.appendChild(labelGenus);
  detailsOne.appendChild(valueGenus);
  detailsOne.appendChild(labelGroup);
  detailsOne.appendChild(valueGroup);
  detailsOne.appendChild(labelDiet);
  detailsOne.appendChild(valueDiet);
  detailsOne.appendChild(labelLocations);
  detailsOne.appendChild(valueLocations);
  ...
  detailsTwo.appendChild(valueLifestyle);
  detailsTwo.appendChild(labelFamily);
  detailsTwo.appendChild(valueFamily);
  detailsTwo.appendChild(labelSN);
  detailsTwo.appendChild(valueSN);
  detailsTwo.appendChild(labelHabitat);
  detailsTwo.appendChild(valueHabitat);
  detailsTwo.appendChild(labelLifespan);
  detailsTwo.appendChild(valueLifespan);
